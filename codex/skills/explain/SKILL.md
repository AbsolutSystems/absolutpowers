...
Zakres: argument użytkownika. Jeśli użytkownik nie podał zakresu, użyj bieżącego stanu repozytorium.
...
- Czysty, czytelny CSS inline: sekcje jako karty, lekka kolorystyka, dobra typografia, max-width ~900px wyśrodkowane. Wspieraj `prefers-color-scheme` (jasny i ciemny).
