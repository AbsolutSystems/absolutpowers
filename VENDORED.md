...
| `finishing-a-development-branch` | `skills/finishing-a-development-branch/` | `d884ae0` | Skopiowany bez zmian treści poza notą MIT. **5.2.0:** banner na górze — w AbsolutPowers preferuj `@ship`; ten skill = opcjonalne menu merge/PR/worktree z obry. Polityka: `references/fork-policy.md`. |
