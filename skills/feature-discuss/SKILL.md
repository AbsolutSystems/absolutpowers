...
3. **Planuj chirurgicznie.** Każdy planowany krok i plik musi wynikać bezpośrednio z celu albo z koniecznej zmiany towarzyszącej (testu, migracji, kontraktu lub usunięcia osieroconego elementu stworzonego przez tę zmianę). Nie rozdmuchuj planu o refaktory, porządki ani poprawki sąsiedniego kodu — ale gdy przy analizie trafisz na realny problem obok (bug, śmieć, złamana konwencja), nie chowaj go po cichu ani nie milcz: nazwij go (plik:linia, na czym polega) i zaproponuj użytkownikowi decyzję — włączyć do zakresu, osobny follow-up, czy pominąć. Ściśle trywialny one-liner (literówka, martwy import) możesz od razu ująć w planie jako zmianę towarzyszącą.
