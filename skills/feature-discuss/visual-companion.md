...
companion-scripts/start-server.sh --project-dir /path/to/project --open
...
companion-scripts/start-server.sh --project-dir /path/to/project --open --foreground
```
...
```bash
companion-scripts/start-server.sh \
...
```bash
companion-scripts/stop-server.sh $SESSION_DIR
```
...
- Frame template (CSS reference): `companion-scripts/frame-template.html`
- Helper script (client-side): `companion-scripts/helper.js`
