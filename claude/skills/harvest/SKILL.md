...
allowed-tools: Read, Glob, Grep, Bash(git:*), Bash(mkdir:*), Bash(mv:*), Bash(npx @mermaid-js/mermaid-cli:*), Write(**/.claude/skills/learned/**/*.md), Write(**/docs/modules/**/*.md), Write(**/docs/architecture/**/*.html), Write(**/absolutpowers/archives/**/*.md)
